...
$servers->setValue('server','force_may',array('uidNumber','gidNumber','sambaSID'));
*/
$servers->setValue('server','host','192.168.100.0');
$servers->setValue('server','base',array('dc=,dc='));
$servers->setValue('login','bind_id','cd=,dc=,dc=');
// $config->custom-appearence['hide_template_warning'] = true;
?>
